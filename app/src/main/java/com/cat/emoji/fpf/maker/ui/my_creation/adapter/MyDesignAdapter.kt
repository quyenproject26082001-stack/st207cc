package com.cat.emoji.fpf.maker.ui.my_creation.adapter
...
import com.cat.emoji.fpf.maker.databinding.ItemMyDesignBinding
import java.io.File
...
class MyDesignAdapter : BaseAdapter<MyAlbumModel, ItemMyDesignBinding>(ItemMyDesignBinding::inflate) {
    ...
    override fun onBindHolder(holder: BaseViewHolder, binding: ItemMyDesignBinding, item: MyAlbumModel, position: Int) {
        binding.apply {
