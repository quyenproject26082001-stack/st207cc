...
class ViewActivity : BaseActivity<ActivityViewBinding>() {
    ...
    private fun checkAndShowEditButtonForDesign() {
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            val isEditableEmoji = try {
                val emojiEditList = com.cat.emoji.fpf.maker.core.helper.MediaHelper
    ...
    private fun resetMyCreationSelectionMode() {
        ...
        if (myCreationActivity != null) {
            ...
            if (emojiFragment is com.cat.emoji.fpf.maker.ui.my_creation.fragment.MyEmojiFragment) {
                emojiFragment.resetSelectionMode()
            }

            val designFragment =
                myCreationActivity.supportFragmentManager.findFragmentByTag("MyDesignFragment")
            if (designFragment is com.cat.emoji.fpf.maker.ui.my_creation.fragment.MyDesignFragment) {
