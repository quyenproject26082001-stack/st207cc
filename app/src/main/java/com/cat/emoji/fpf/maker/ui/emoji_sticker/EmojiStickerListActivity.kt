...
import com.cat.emoji.fpf.maker.core.utils.share.telegram.TelegramSharing
import com.cat.emoji.fpf.maker.core.utils.share.whatsapp.IdGenerator
import com.cat.emoji.fpf.maker.core.utils.share.whatsapp.StickerBook
import com.cat.emoji.fpf.maker.core.utils.share.whatsapp.StickerPack
...
import com.cat.emoji.fpf.maker.databinding.ActivityEmojiStickerListBinding
    ...
    private fun processWhatsApp(packageName: String, urls: List<String>) {
        lifecycleScope.launch {
            ...
            val packId = IdGenerator.generateIdFromUrl(
                ...
                com.cat.emoji.fpf.maker.core.helper.StringHelper.generateRandomString(10)
            )
