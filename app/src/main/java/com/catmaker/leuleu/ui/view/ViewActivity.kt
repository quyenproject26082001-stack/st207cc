package com.catmaker.leuleu.ui.view
...
import com.catmaker.leuleu.core.extensions.loadImageFromFile
...
import com.catmaker.leuleu.databinding.ActivityViewBinding
    ...
    private fun checkAndShowEditButtonForDesign() {
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            val isEditableEmoji = try {
                val emojiEditList = com.catmaker.leuleu.core.helper.MediaHelper
                    .readListFromFile<com.catmaker.leuleu.data.model.custom.EmojiEditModel>(
                        this@ViewActivity,
